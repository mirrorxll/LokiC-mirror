...
ActiveRecord::Schema.define(version: 2020_10_19_070617) do
  ...
  create_table "ga_county_population", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "id"
    t.text "county", size: :tiny
    t.integer "year"
