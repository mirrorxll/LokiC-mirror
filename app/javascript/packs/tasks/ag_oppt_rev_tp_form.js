...
window.$('#add_client').on('click', (e)=> {
    ...
    let agenciessSelect = document.createElement('select')
    agenciessSelect.appendChild(document.createElement('option'))
    agenciessSelect.id = `data_set_default_${uId}_client_id`
    agenciessSelect.name = `default_props[client_tag_ids[${uId}[client_id]]]`
    agenciessSelect.className = 'form-control form-control-sm clients_select'
    agenciessSelect.required = true
    agenciessSelect.addEventListener('change', publicationsByClient)
    agenciessSelect.addEventListener('change', tagsByPublication)
    ...
    clientsCol.appendChild(agenciessSelect)
