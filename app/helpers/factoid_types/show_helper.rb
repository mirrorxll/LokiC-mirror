module FactoidTypes::ShowHelper
  def factoid_types_blocked_item?
    true unless [@factoid_type.staging_table_attached.eql?(false), @factoid_type.staging_table&.indices_modifying.eql?(true),
                 @factoid_type.staging_table&.columns_modifying.eql?(true), @iteration.population.eql?(false),
