...
module StoryTypes
  class BackdateExportTask < StoryTypesTask
    def perform
      Slack::Web::Client.new.chat_postMessage(channel: 'U024ZKRR8AE', message: 'Backdate export has been started')
      ...
      Slack::Web::Client.new.chat_postMessage(channel: 'U024ZKRR8AE', message: 'Backdate export has been finished')
    end
  end
end
